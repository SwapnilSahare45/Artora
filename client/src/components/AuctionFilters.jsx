...
const AuctionFilters = () => {
  return (
    <div className="h-full overflow-y-scroll bg-white shadow dark:bg-gray-800 dark:text-white w-full rounded">
      <h2 className="text-lg font-semibold mb-4 sticky top-0 bg-white dark:bg-gray-800 py-4 text-center shadow">Auction Filters</h2>
      ...
      <div className="mb-6 px-4">
        <h3 className="text-sm font-semibold mb-2">Bid Range</h3>
        <input
          type="range"
          min="1000"
          max="100000"
